...
<main>
	...
	<ImageSingle
		...
		maxWidth="1180px"
		link="Yes"
		caption="Toronto fire insurance plan covering Kensington Market. 1889."
	...
	<div class="text">
		...
		>
			<p>
				<span class="caption-text"
					>Street scenes in Kensington Market in the 1970s by Ellis Wiley.
				</span>
				<span class="caption-source"
	...
	<div class="text">
		<p>
			Change is a constant in urban centres, and Kensington is no different. But this particular change has met with strong reactions	from inside and outside the neighbourhood’s boundaries. The decline of Kensington Market’s legacy businesses and food sellers is a recurring theme in local Toronto reporting, with scores of articles on this topic over the past decades.<Footnote
				id={addFootnote(fns[1])}
			/> The reasons cited for the change are diverse, from unaffordable commercial rents, changing patterns of immigrant entrepreneurship, and a different visitor profile with changing interests in goods and experiences.
		</p>
		<p>
	...
	<div class="text">
		<p>
			The City of Toronto has prioritized small businesses in its <a href="https://www.toronto.ca/city-government/accountability-operations-customer-service/long-term-vision-plans-and-strategies/action-plan-toronto-economy/" target="_blank">recent economic strategy</a>. Pandemic-era public health measures disproportionately affected small businesses, spurring targeted programs like <a href="https://www.toronto.ca/business-economy/business-operation-growth/business-support/main-street-recovery-rebuild-initiative/"target="_blank">Mainstreet Recovery and Rebuilding Initiative</a> meant to help vulnerable businesses bounce back from this unprecedented challenge.
		</p>
		<p>
	...
	<div class="text">
		...
		<p>
			We compiled data from a variety of sources to verify and understand the scale of business type change in Kensington Market over time.<Footnote
				id={addFootnote(fns[10])}
			/> In July and August of 2025, we confirmed the presence of current businesses by walking through the Market, verifying and updating online data, and talking to market shop owners and residents. We then compiled historical business data from a series of older sources, including data collected by volunteers from the KMCLT and by members of the Kensington Market Historical Society. This was supplemented with Data Axle’s Canadian Historical Business Data (2009-2022), a large dataset that we refined and cross-checked against our other sources.<Footnote id={addFootnote(fns[11])} />
		</p>
		<p>
		...
		<ul>
			<li>
				...
				> art galleries, studios, performance spaces, cinemas, recording studios
			</li>
			<li>
				<span class="highlight" style="background-color: #5ac7da;"
					>Medical:</span
				> medical facilities, doctors' and dentists' offices, clinics, Toronto Western Hospital
			</li>
			<li>
				<span class="highlight" style="background-color: #82a0d3;"
					>Services:</span
				> salons, tattoo parlors, car rentals and mechanics, laundromats, plumbers, banks
			</li>
			<li>
				<span class="highlight" style="background-color: #e1c542;"
					>Social / community:</span
				> houses of worship, non-profit social service organizations, community organizations and associations, schools and educational institutions
			</li>
			<li>
				<span class="highlight" style="background-color: #1b8079;"
					>Foodstuffs:</span
				> sellers of raw and dry goods, cheese shops, butchers, bakeries, fish sellers, spices, health food stores
			</li>
			<li>
				<span class="highlight" style="background-color: #6459a7;"
					>Retail:</span
				> specialty stores, boutiques, vintage clothing stores, cannabis, mushrooms and vapes
			</li>
			<li>
	...
	<GraphicSingle
		svg1080="./nested-donut-1080.svg"
		svg720="./nested-donut-720.svg"
		svg360="./nested-donut-360.svg"
	/>
	...
	<div class="text">
		...
		<p>
			Kensington Market’s retailers are diverse and numerous (121 or 29.5%), percentagewise nearly on par with the restaurants and bars (134 or 32.7%). The retail category includes a sizeable number of specialty stores (56) and vintage clothing stores (24). In 2025, <a
			...
			>, make up just 12.4% of retail. The businesses identified as offering services, including 14 salons and 7 tattoo parlors, add to the commercial diversity and contribute significantly to the Market as a pedestrian destination.
		</p>
		<p>
			Stores selling cannabis, mushrooms, and vapes collectively represent nearly 11% of all retail in Kensington Market and 3% of the neighbourhood’s overall non-residential activity. While cannabis legalization has played a role in this sector’s growth, the history of cannabis retailing in the Market precedes its 2018 legalization by several decades. Toronto’s very first cannabis consumption lounge
			<a
			...
			> (originally called Roach-o-Rama) opened in Kensington in 2000 and closed in 2022. As of 2025, there are 8 cannabis retailers in the neighbourhood.
		</p>
		<p>
	...
	<div class="text">
		...
		<p>
			...
			interactive map and timeline showing the change of grocers into other types of businesses from 2007 to 2025. The map consolidates multiple data points into a single framework.
		</p>
		<p>
	...
	<div class="text">
		...
		<p>
			In 2025, the City of Toronto designated Kensington Market a Heritage Conservation district, preserving the built environment and recognizing that the Market’s “fine-grain commercial space has contributed to the concentration of independent businesses that support a sense of place and a uniquely animated public realm”.<Footnote
				id={addFootnote(fns[14])}
			/>
			While this designation acknowledges the historic importance of small business in the Market, without concrete economic policies, it is hard to imagine how small businesses such as green grocers can thrive, let alone survive. 
		</p>
		<p>
			In February 2026, the City of Toronto announced that it would
			<a
				href="https://www.toronto.ca/news/city-of-toronto-lowers-small-business-property-taxes-through-2026-budget/"
				target="_blank">lower small business property taxes</a>, and its stated intention is to limit commercial rents by 2030, suggest the municipality’s willingness to take steps to lessen small businesses’ economic vulnerability.
		</p>
		<p>
