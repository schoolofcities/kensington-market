# Timeline visualization with scatter plot and S-curved lines
library(jsonlite)
library(plotly)
...
# Collect all businesses and their transitions
...
# Layout
fig <- fig %>% layout(
  title = "Individual Business Transitions in Kensington Market (2007-2025)",
  xaxis = list(
    title = "Year",
    tickmode = "linear",
    tick0 = start_year,
...
# htmlwidgets::saveWidget(fig, "business_transitions_timeline.html", selfcontained = TRUE)